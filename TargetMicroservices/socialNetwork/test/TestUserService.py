...
def register():
    ...
    client.RegisterUser(
        req_id, "first_name_0", "last_name_0", "username_11114", "password_0", {}
    )
    client.RegisterUserWithId(
        req_id, "first_name_1", "last_name_1", "username_1", "password_1", 1, {}
    )
    client.RegisterUserWithId(
        req_id, "first_name_2", "last_name_2", "username_2", "password_2", 2, {}
    )
    transport.close()
