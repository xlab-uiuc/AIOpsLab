    ...
    def write(self, oprot):
        ...
        if self.media_types is not None:
            ...
            for iter127 in self.media_types:
                oprot.writeString(
                    iter127.encode("utf-8") if sys.version_info[0] == 2 else iter127
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.carrier is not None:
            ...
            for kiter128, viter129 in self.carrier.items():
                oprot.writeString(
                    kiter128.encode("utf-8") if sys.version_info[0] == 2 else kiter128
                )
                oprot.writeString(
                    viter129.encode("utf-8") if sys.version_info[0] == 2 else viter129
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
