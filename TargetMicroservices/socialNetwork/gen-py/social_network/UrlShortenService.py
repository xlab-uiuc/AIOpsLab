...
class Client(Iface):
    ...
    def recv_ComposeUrls(self):
        ...
        raise TApplicationException(
            TApplicationException.MISSING_RESULT, "ComposeUrls failed: unknown result"
        )
    ...
    def recv_GetExtendedUrls(self):
        ...
        raise TApplicationException(
            ...
            "GetExtendedUrls failed: unknown result",
        )
...
class Processor(Iface, TProcessor):
    ...
    def process_ComposeUrls(self, seqid, iprot, oprot):
        ...
        result = ComposeUrls_result()
        try:
            result.success = self._handler.ComposeUrls(
                args.req_id, args.urls, args.carrier
            )
    ...
    def process_GetExtendedUrls(self, seqid, iprot, oprot):
        ...
        result = GetExtendedUrls_result()
        try:
            result.success = self._handler.GetExtendedUrls(
                args.req_id, args.shortened_urls, args.carrier
            )
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
    ...
    def write(self, oprot):
        ...
        if self.urls is not None:
            ...
            for iter341 in self.urls:
                oprot.writeString(
                    iter341.encode("utf-8") if sys.version_info[0] == 2 else iter341
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.carrier is not None:
            ...
            for kiter342, viter343 in self.carrier.items():
                oprot.writeString(
                    kiter342.encode("utf-8") if sys.version_info[0] == 2 else kiter342
                )
                oprot.writeString(
    ...
    def write(self, oprot):
        ...
        if self.shortened_urls is not None:
            ...
            for iter364 in self.shortened_urls:
                oprot.writeString(
                    iter364.encode("utf-8") if sys.version_info[0] == 2 else iter364
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.carrier is not None:
            ...
            for kiter365, viter366 in self.carrier.items():
                oprot.writeString(
                    kiter365.encode("utf-8") if sys.version_info[0] == 2 else kiter365
                )
                oprot.writeString(
                    viter366.encode("utf-8") if sys.version_info[0] == 2 else viter366
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter373 in self.success:
                oprot.writeString(
                    iter373.encode("utf-8") if sys.version_info[0] == 2 else iter373
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.se is not None:
